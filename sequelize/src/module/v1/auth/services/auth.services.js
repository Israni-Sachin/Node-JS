...
const login = async (data) => {
        ...
        let user = await Users.findOne({where: { user_email: data.user_email }});
        ...
        let encodedData = createToken({ id: userData.id, role: userData.user_role });
...
const register = async (data) => {
        ...
        let check = await Users.findOne({ where: { user_email: data.user_email } });
        ...
        const user = await Users.findOne({ where: { user_email: data.user_email } });
